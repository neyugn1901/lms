        ...
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    <li class="active"><a href="{{ route('user.index') }}">Người dùng</a></li>
                    {{-- <li><a href="dashboard_2.html">Nhóm người dùng</a></li> --}}
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    ...
                    {{-- <li><a href="dashboard_2.html">Nhóm người dùng</a></li> --}}
                    <li class="active"><a href="{{ route('course.index') }}">Khóa học</a></li>
                </ul>
            </li>
