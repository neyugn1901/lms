        ...
        <!-- Toastr style -->
        <link href="{{ asset('assets_admin/css/plugins/toastr/toastr.min.css') }}" rel="stylesheet">
        
        <!-- Gritter -->
        <link href="{{ asset('assets_admin/js/plugins/gritter/jquery.gritter.css') }}" rel="stylesheet">
